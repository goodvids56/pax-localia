...
const datasets: readonly DatasetDefinition[] = [
  ...
  {
    id: 'map:july-crisis-v1',
    columns: 3,
    rows: 3,
    origin: [20, 36],
    cell: [2.2, 2],
    regions: [
      { id: 'region:bosnia', name: 'Bosnia and Herzegovina' },
      { id: 'region:croatia', name: 'Croatia-Slavonia' },
      { id: 'region:austria', name: 'Austrian Lands' },
      { id: 'region:serbia', name: 'Serbia' },
      { id: 'region:hungary', name: 'Hungarian Lands' },
      { id: 'region:romania', name: 'Romania' },
      { id: 'region:montenegro', name: 'Montenegro' },
      { id: 'region:macedonia', name: 'Vardar Macedonia' },
      { id: 'region:bulgaria', name: 'Bulgaria' },
    ],
  },
  {
